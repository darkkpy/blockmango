#Upgraded groupchat.py
from .http import HTTPMixin
from .config import BASE_URL_GROUP, BASE_URL_GROUP_V2
...
class Group(HTTPMixin):
    ...
    def create(self, member_ids):
        ...
        return self._make_request('POST', endpoint, headers=self.headers, json_data=json_data)
    ...
    def allow_invite(self, group_id, group_name, invite_status):
        ...
        return self._make_request('PUT', endpoint, headers=self.headers, json_data=json_data)
    ...
    def quit(self, group_id, group_name):
        ...
        return self._make_request('PUT', endpoint, headers=self.headers, params=params)

    def apply(self, group_id, msg):
        endpoint = f"{BASE_URL_GROUP}/msg/group/chat/apply"
        params = {"groupId": group_id, "msg": msg}
        return self._make_request('POST', endpoint, headers=self.headers, params=params)
